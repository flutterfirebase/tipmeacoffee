...
async function verifyMail(rAddress, message) {
    ...
    let info = await transporter.sendMail({ from: 'BeSocial <verification@besocial.ai>', to: rAddress, subject: "Verify Email Address", html: message, });
}
